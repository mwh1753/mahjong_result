...
# ------------------------------------------------
# 1. 닉네임 사전 (오타 철벽 방어 대거 포함) 및 우마 계산
# ------------------------------------------------
NAME_DICTIONARY = {
    # 알파벳 형태 혼동 방어 (e/c, l/I/1, n/m 혼동)
    "keichi": "정훈", "kelchi": "정훈", "ketchi": "정훈", 
    "sleeeeeeeep": "도균", "sleeeeeeep": "도균", "sleeeeeeeeep": "도균", "s1eeeeeeeep": "도균", 
    "koyume": "동욱", "koynme": "동욱", "kcyume": "동욱",
    "babysunfish": "선일", "babysunf1sh": "선일", "hahysunfish": "선일",
    "jeezjz": "지성", "jeezj2": "지성", "jee2jz": "지성", "jeczjz": "지성",
    "MANKURU": "태욱", "MANKURV": "태욱", "MANKUKU": "태욱",
    "lecon": "동희", "Iecon": "동희", "1econ": "동희", "lacon": "동희",
    "tminid": "박정우", "tminld": "박정우", "tmInid": "박정우", "tmin1d": "박정우",
    "Maeil": "근협", "MaeiI": "근협", "Maei1": "근협", "Meeil": "근협",
    "wakhang": "정완", "wakhong": "정완", "wekhang": "정완",
    "joyhome": "이정우", "jcyhome": "이정우", "joyhoma": "이정우",
    "gtrhdea": "정학", "gtrhdee": "정학", "ytrhdea": "정학",
    "Reippah": "종현", "Reippeh": "종현", "Relppah": "종현",
    "hoshizoraaaa": "창민", "hoshizoraaa": "창민", "hoshlzoraaaa": "창민", 
    "zxxzxx": "승현", "2xx2xx": "승현", "zxx2xx": "승현",
    "lJpuddingl": "재형", "1Jpudding1": "재형", "IJpuddingI": "재형", "lJpudding1": "재형", 
    "Kyorang": "교창", "Kyarang": "교창", "Kyoreng": "교창",

    # 한글 형태 혼동 방어 (ㅐ/ㅔ, ㅗ/ㅜ, ㅅ/ㅈ/ㅊ 혼동 등)
    "이쁜괜티": "규빈", "이쁜괜히": "규빈", "이픈괜티": "규빈", "이쁜쾐티": "규빈",
    "김근머": "근영", "김근며": "근영", "길근머": "근영", "감근머": "근영",
    "테라짐": "도헌", "데라짐": "도헌", "테라잠": "도헌", "톄라짐": "도헌",
    "하루를영원히": "민철", "하루룰영원히": "민철", "하루를영원히": "민철", "하루를영윈히": "민철",
    "넘버걸": "범진", "넙버걸": "범진", "넘버결": "범진", "님버걸": "범진",
    "새벽녕": "재현", "새벽명": "재현", "세벽녕": "재현", "새벽령": "재현",
    "제라툴": "재훈", "계라툴": "재훈", "재라툴": "재훈", "제리툴": "재훈",
    "시나몬샐러드": "나경", "시나몬셀러드": "나경", "사나몬샐러드": "나경",
    "쉿자는중": "지완", "찻자는중": "지완", "숫자는중": "지완", "솟자는중": "지완", "찾자는중": "지완",
    "오천리더": "재윤", "으천리더": "재윤", "오천라더": "재윤", "오친리더": "재윤",
    "닷시마": "혜림", "딧시마": "혜림", "닫시마": "혜림", "맛시마": "혜림",
    "스도리": "태민", "스도라": "태민", "츠도리": "태민",
    "찐빵vs호빵": "두찬", "찐빵vS호빵": "두찬", "찐빵VS호빵": "두찬", "짠빵vs호빵": "두찬", "찐빵vs후빵": "두찬",
    "밤하늘먹구름": "승훈", "밤하늘벅구름": "승훈", "밤하늘먹꾸름": "승훈", "빔하늘먹구름": "승훈",
    "소외감": "우영", "소의감": "우영", "스외감": "우영", "쇠외감": "우영",
    "가우르구라원툴": "상현", "가오르구라원툴": "상현", "기우르구라원툴": "상현", "가우르구리원툴": "상현",
    "실루엣": "우재", "쉴루엣": "우재", "설루엣": "우재", "살루엣": "우재",
    "한국의기술": "유준", "한극의기술": "유준", "한국이기술": "유준",

    # 일본어/한자 형태 혼동 방어 (탁점, 비슷한 한자 혼동)
    "うああつあ": "우혁", "うあぁつあ": "우혁", "ぅああつあ": "우혁", "5ああつあ": "우혁",
    "平澤文": "기형", "平沢文": "기형", "乎澤文": "기형",
    "あやフブミオ": "재욱", "あやフプミオ": "재욱", "あやフフミオ": "재욱"
}
